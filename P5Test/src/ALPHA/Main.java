 ...
 *  6/2/2018 : ALPHA
 *
 * TODO: FIX WEBCAM SITUATION
 *
 * PORT alpha.pde to this Main.java
 * Keep the alpha codebase in sync between PROCESSING_CODE and P5_JAVA
 *
 *
 * OG NOTES:
 *
...
//TODO: figure out why JAVA can't connect to webcam, yet PROCESSING can
...
print("gifsicle -i -l -t=255 -D=2 -d42 "+PNG_OUT+"*.gif > "+SKETCH_PATH+"/"+ fix.pdeName()+fix.getTimestamp()+"_preview.gif  \n");
...
//        save(  PNG_OUT + pdeName() + getTimestamp() + ".png");
        ...
        save(  PNG_OUT + fix.pdeName() + fix.getTimestamp() + ".gif");
    }
